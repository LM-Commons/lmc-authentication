...
const config = {
  title: 'Lmc Authentication',
  tagline: 'Authentication for Mezzio applications',
  ...
  baseUrl: '/lmc-authentication',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'lm-commons',
  projectName: 'lmc-authentication', // Usually your repo name.
  trailingSlash: false,
...
//          {to: '/blog', label: 'Blog', position: 'left'},
          ...
          {
            href: 'https://github.com/lm-commons/lmc-authentication',
            label: 'GitHub',
            position: 'right',
          },
        ],
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub',
                href: 'https://github.com/lmc-commons/lmc-authentication',
              },
            ],
          },
        ],
